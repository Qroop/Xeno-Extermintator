...
Enemy::Enemy(sf::Vector2f coordinates, sf::Texture& texture, sf::RenderWindow& window, int health_points, int damage, int speed, Game_Object& player, double rotation)
: Entity(coordinates, texture, window, health_points, damage, speed, rotation), player{player}
{
